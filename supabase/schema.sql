-- GTC Soluciones - esquema inicial para plataforma de capacitacion.
-- Ejecutar en Supabase SQL Editor despues de crear el proyecto.
...
create table if not exists public.profiles (
  ...
  full_name text,
  email text,
  role text not null default 'alumno' check (role in ('superadmin', 'alumno')),
  company text,
  phone text,
